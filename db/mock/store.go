...
// Source: github.com/zaenalarifin12/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetSession(arg0 context.Context, arg1 string) (db.Sessions, error) {
	m.ctrl.T.Helper()
...
// TransferList mocks base method.
func (m *MockStore) TransferList(arg0 context.Context, arg1 db.TransferListParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferList", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TransferList indicates an expected call of TransferList.
func (mr *MockStoreMockRecorder) TransferList(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransferList", reflect.TypeOf((*MockStore)(nil).TransferList), arg0, arg1)
}
